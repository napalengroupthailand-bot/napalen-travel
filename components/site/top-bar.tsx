...
export function TopBar() {
  ...
  return (
    <div className="border-b border-white/10 bg-white/10 text-bright-sky/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-1.5 px-3 py-1.5 text-[10px] sm:flex-row sm:px-4 sm:py-2 sm:text-xs">
        ...
        <div className="flex items-center gap-2 font-medium sm:gap-3">
          <span className="flex items-center gap-1.5 rounded-full border border-white/25 bg-white/10 px-2.5 py-0.5 backdrop-blur-sm">
